        ...
        for (Message message : pendingMessages) {
            try {
                ...
                if (reply != null) {
                    ...
                    message.setTitle(message.getDescription());
                    ...
                    for (Card card : cardList) {
                        if (card.getName().equals(message.getTitle())) {
                            selectedCard = card;
                    ...
                    trello.overwriteCardName(selectedCard.getId(),"#" + numberOfFinishedCards + " " + selectedCard.getName());
